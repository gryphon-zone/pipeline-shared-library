...
class EffectiveDockerPipelineTemplateConfiguration {
     ...
     */
    List<EffectiveDockerPipelineTemplateSingleImageConfiguration> images

    String buildStageName

    String pushStageName
